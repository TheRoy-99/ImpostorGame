...
export default function EndRoundScreen() {
  ...
  return (
    <View style={styles.container}>
        ...
        {!revealed ? (
          <>
            <View style={styles.mysteryIconCircle}>
              <Ionicons name="help" size={36} color={Colors.purple} />
            </View>
      ...
      <TouchableOpacity style={styles.btnSecondary} onPress={() => { reset(); router.replace('/'); }}>
        <Ionicons name="trash-outline" size={16} color={Colors.textSecondary} />
        <Text style={styles.btnSecondaryText}>Reiniciar todo</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  container:           { flex: 1, backgroundColor: Colors.bg, padding: 28, alignItems: 'center', justifyContent: 'center', gap: 14 },
  title:               { color: Colors.white, fontSize: 28, fontFamily: Fonts.display, textAlign: 'center', letterSpacing: -1 },
  ...
  mysteryCard:         { width: '100%', backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 24, padding: 36, alignItems: 'center', gap: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)', elevation: 0 },
  mysteryCardRevealed: { backgroundColor: 'rgba(124,58,237,0.15)', borderColor: Colors.purple },
  mysteryIconCircle:   { width: 72, height: 72, borderRadius: 36, backgroundColor: Colors.purplePale, alignItems: 'center', justifyContent: 'center' },
  ...
  btnSecondary:        { width: '100%', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: 'rgba(255,255,255,0.05)', borderRadius: 20, paddingVertical: 18, borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)', elevation: 0 },
  ...
  modalCard:           { width: '100%', backgroundColor: '#131829', borderRadius: 24, padding: 32, alignItems: 'center', gap: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.10)' },
  modalIconCircle:     { width: 64, height: 64, borderRadius: 32, backgroundColor: Colors.purplePale, alignItems: 'center', justifyContent: 'center' },
