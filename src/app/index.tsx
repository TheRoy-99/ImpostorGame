  ...
  return (
    <ScrollView style={styles.scroll} contentContainerStyle={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.sub}>Configura tu partida</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  header:        { marginBottom: 36, alignItems: 'center', gap: 8 },
  logoCircle:    { width: 64, height: 64, borderRadius: 32, backgroundColor: Colors.purple, alignItems: 'center', justifyContent: 'center', marginBottom: 4 },
  ...
  inputFlex:     { flex: 1 },
  addBtn:        { width: 48, height: 48, borderRadius: 14, backgroundColor: Colors.purple, alignItems: 'center', justifyContent: 'center', elevation: 0 },
  ...
  chip:          { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: Colors.purplePale, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, borderWidth: 1, borderColor: Colors.bgCardBorder },
  chipText:      { color: Colors.textSecondary, fontSize: 13, fontFamily: Fonts.bodyBold },
  toggleRow:     { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: Colors.bgCard, borderRadius: 20, padding: 18, borderWidth: 1, borderColor: Colors.bgCardBorder, marginBottom: 28 },
  ...
  btnPrimary:    { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: Colors.purple, borderRadius: 20, paddingVertical: 18, elevation: 0 },
